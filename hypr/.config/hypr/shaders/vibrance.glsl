 ...
 */
    ...
    #define VIBRANCE_INTENSITY 1.5  // Default fallback value
#endif

// Balance: 0.0 to 1.0
// Controls preservation of skin tones (higher values preserve skin tones more)
#ifndef SHADER_VIBRANCE_SKIN_TONE_PROTECTION
    #define SHADER_VIBRANCE_SKIN_TONE_PROTECTION 0.0  // Default fallback value
#endif
...
void main() {
    ...
    fragColor = vec4(result * 1.3, pixColor.a);
}
